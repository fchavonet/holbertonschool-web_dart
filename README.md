...
| **FILE**             | **DESCRIPTION**                                                  |
| :------------------: | ---------------------------------------------------------------- |
| `0x00-hello-dart`    | Introduction to Dart syntax, variables, strings, and assertions. |
| `0x01-dart-function` | Functions, recursion, collections, and logic in Dart.            |
| `0x02-dart-classes`  | Object-Oriented Programming: classes, inheritance, and JSON.     |
| `0x03-asynchronous`  | Futures, async/await, error handling, and HTTP requests.         | 
